...
var CommentBox = React.createClass({
  ...
  handleCommentSubmit: function(comment) {
		...
		comment.id = Date.now();
		comment.author=comment.author.substring(0,16);
	...
	componentWillMount: function() {
		this.pusher = new Pusher('f829ca5282dc97707d03');
	...
	componentDidMount: function() {
		...
		this.chatRoom.bind('new_message', function(message){
			var comments=this.state.data;
			var newComments=comments.concat([message]);
			this.setState({data: newComments});
...
function update(){
	...
	$( ".commentAuthor:not(.clickable)" ).click(function() {
		nameSet = $("#inputText").val() + $(this).text();
	});
